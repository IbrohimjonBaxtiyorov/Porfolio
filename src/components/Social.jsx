        ...
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            <TooltipTrigger
              ...
              onClick={() => {
                window?.open(
                  "https://www.linkedin.com/in/ibrohim-baxtiyorov/",
                  "_blank"
                );
              }}
            >
        ...
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            <TooltipTrigger
              ...
              onClick={() => {
                window?.open(
                  "mailto:baxtiyorovibrohim513@gmail.com?subject=Ibrohimga xat"
                );
              }}
            >
              <svg
        ...
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            <TooltipTrigger
              ...
              onClick={() => {
                window?.open("https://github.com/IbrohimjonBaxtiyorov", "_blank");
              }}
            >
              <GitHubLogoIcon />
            </TooltipTrigger>
